...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_inclusion = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        self.label_inclusion.setObjectName("label_inclusion")
        self.verticalLayout_8.addWidget(self.label_inclusion)
        self.lineEdit_inclusion = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.lineEdit_inclusion.setObjectName("lineEdit_inclusion")
        self.verticalLayout_8.addWidget(self.lineEdit_inclusion)
        self.pushButton_inclusion = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.pushButton_inclusion.setObjectName("pushButton_inclusion")
        self.verticalLayout_8.addWidget(self.pushButton_inclusion)
        self.label_exclusion = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        self.label_exclusion.setObjectName("label_exclusion")
        self.verticalLayout_8.addWidget(self.label_exclusion)
        self.lineEdit_exclusion = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.lineEdit_exclusion.setObjectName("lineEdit_exclusion")
        self.verticalLayout_8.addWidget(self.lineEdit_exclusion)
        self.pushButton_exclusion = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.pushButton_exclusion.setObjectName("pushButton_exclusion")
        self.verticalLayout_8.addWidget(self.pushButton_exclusion)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_inclusion.setText(_translate("MainWindow", "Inclusion Criterion"))
        self.pushButton_inclusion.setText(_translate("MainWindow", "Add Inclusion Criterion"))
        self.label_exclusion.setText(_translate("MainWindow", "Exclusion Criterion"))
        self.pushButton_exclusion.setText(_translate("MainWindow", "Add Exclusion Criterion"))
