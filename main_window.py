...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("resources/icon_logo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_matched_pages = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        self.label_matched_pages.setObjectName("label_matched_pages")
        self.verticalLayout_3.addWidget(self.label_matched_pages)
        self.listWidget_matched_pages = QtWidgets.QListWidget(self.verticalLayoutWidget_2)
        ...
        self.label_match_criteria = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_match_criteria.setObjectName("label_match_criteria")
        self.verticalLayout_5.addWidget(self.label_match_criteria)
        self.listWidget_search_criteria = QtWidgets.QListWidget(self.verticalLayoutWidget)
        ...
        self.pushButton_remove_criterion = QtWidgets.QPushButton(self.verticalLayoutWidget)
        ...
        self.pushButton_clear_criteria = QtWidgets.QPushButton(self.verticalLayoutWidget)
        ...
        self.label_plain_text = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        self.label_plain_text.setObjectName("label_plain_text")
        self.verticalLayout_8.addWidget(self.label_plain_text)
        self.lineEdit_plain_text = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.lineEdit_plain_text.setObjectName("lineEdit_plain_text")
        self.verticalLayout_8.addWidget(self.lineEdit_plain_text)
        self.pushButton_add_plain_text = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.pushButton_add_plain_text.setObjectName("pushButton_add_plain_text")
        self.verticalLayout_8.addWidget(self.pushButton_add_plain_text)
        self.label_element = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        self.label_element.setObjectName("label_element")
        self.verticalLayout_8.addWidget(self.label_element)
        self.lineEdit_html_element = QtWidgets.QLineEdit(self.verticalLayoutWidget_3)
        self.lineEdit_html_element.setObjectName("lineEdit_html_element")
        self.verticalLayout_8.addWidget(self.lineEdit_html_element)
        self.pushButton_add_element = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.pushButton_add_element.setObjectName("pushButton_add_element")
        self.verticalLayout_8.addWidget(self.pushButton_add_element)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("feather/upload.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionReset_Criteria = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("feather/x.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReset_Criteria.setIcon(icon4)
        self.actionReset_Criteria.setObjectName("actionReset_Criteria")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("feather/file-text.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("feather/map.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCrawl.setIcon(icon8)
        self.actionCrawl.setObjectName("actionCrawl")
        self.actionMatch = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("feather/tag.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("feather/external-link.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_Page_in_Web_Browser.setIcon(icon12)
        ...
        self.menuEdit.addAction(self.actionReset_Criteria)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_schema.setCurrentText(_translate("MainWindow", "http://"))
        self.comboBox_schema.setItemText(0, _translate("MainWindow", "http://"))
        self.comboBox_schema.setItemText(1, _translate("MainWindow", "https://"))
        ...
        self.pushButton_remove_criterion.setText(_translate("MainWindow", "Remove Criterion"))
        ...
        self.pushButton_add_plain_text.setText(_translate("MainWindow", "Add Plain Text"))
        self.label_element.setText(_translate("MainWindow", "HTML Element (experimental)"))
        self.pushButton_add_element.setText(_translate("MainWindow", "Add HTML Element"))
        ...
        self.actionReset_Criteria.setText(_translate("MainWindow", "Reset Search Criteria"))
        self.actionReset_Criteria.setShortcut(_translate("MainWindow", "Ctrl+R"))
